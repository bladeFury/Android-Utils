...
import common.bladefury.us.ShellUtils;
...
public class PackageUtils {
	...
	public static final int install(Context context, String filePath) {
		if (!PackageUtils.isSystemApplication(context)) {
			...
			Log.d("Root", "root1==" + isRoot);
			if (!isRoot) {
				// 为获得ROOT权限
				Log.d("Root", "root2==" + isRoot);
	...
	public static final boolean root(Context context) {
		if (!PackageUtils.isSystemApplication(context)) {
			boolean isRoot = ShellUtils.checkRootPermission();
			Log.d("Root", "rooty==" + isRoot);
			if (!isRoot) {
				return false;
			} else {
				return true;
	...
	public static void startAppByPackageName(Context c, String packageName) {
		final PackageManager pm = c.getPackageManager();
	...
	public static boolean isSystemApplication(PackageManager packageManager,
		...
		try {
			...
			Log.d("boolean-----------------------",
					"boolean---------------"
							+ (app != null && (app.flags & ApplicationInfo.FLAG_SYSTEM) > 0));
...
// Hide details
// Change log
// r26 by trinea1989 on Jun 18, 2013 Diff
// 1 Android common libs include ImageCache,
// ImageSDCardCache, PreloadDataCache,
// DropDownListView, SlideOnePageGallery,
// DownloadManagerPro,
// PackageUtils(installSilent), ShellUtils
// and other common utils
// 2 Uniform code Specification, Comments
// changed to English
// Go to:
// Older revisions
// All revisions of this file
// File info
// Size: 15559 bytes, 383 lines
// View raw file
